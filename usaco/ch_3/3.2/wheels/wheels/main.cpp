...
//    int start;
//    int end;
//    wedge(int a, int b): start(a), end(b) {}
//};
//
//struct wheels{
//    vector<wedge> wedges;
...
//
//    }
//    wheels(int a, int x) : rate(a) {
//        for (int i = 0; i < x; i++) {
//            int c,d;
//            fin >> c >> d;
//            d += c;
//            d %= 360;
//            wedges.push_back(wedge(c,d));
//        }
//    }
//};
//
...
//        int rate, numWedges;
//        fin >> rate >> numWedges;
//        garage[i] = wheels(rate, numWedges);
//    }
//
//    for (int i = 0; i < 360; i++) {
//        bool works = true;
//        for (int j = 0; j < 5; j++) {
//            bool hasGap = false;
//            for (int k = 0; k < garage[j].wedges.size(); k++) {
//                if (garage[j].wedges[k].end < garage[j].wedges[k].start) {
//                    if (i*garage[j].rate%360 >= garage[j].wedges[k].start || i*garage[j].rate%360 <= garage[j].wedges[k].end) {
//                        hasGap = true;
//                        break;
//                    }
//                } else {
